 ...
 */
     ...
     * The metadata.db in the calibre directory will be copied to this directory.
     */
		
	$config['local_directory'] = 'calibre/';
     ...
     */
    $config['cops_recentbooks_limit'] = '24'; 
    
    /*
     * Catalog's title
     */
    $config['cops_title_default'] = "Wayne's Ebooks"; 
     ...
     */
    $config['cops_opds_thumbnail_height'] = "60";
    
    /*
     * Height of thumbnail image for HTML
     */
    $config['cops_html_thumbnail_height'] = "220";
     ...
     * -1 unlimited
     */
    $config['cops_max_item_per_page'] = "24"; 
